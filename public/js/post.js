...
/***/ "./resources/js/components/Post.svelte":
/*!*********************************************!*\
  !*** ./resources/js/components/Post.svelte ***!
  \*********************************************/
...
/* harmony import */ var _post_PostList_svelte__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./post/PostList.svelte */ "./resources/js/components/post/PostList.svelte");
...
/* resources/js/components/Post.svelte generated by Svelte v3.49.0 */
...
function create_fragment(ctx) {
  ...
  var current;
  var postlist_props = {};
  postlist = new _post_PostList_svelte__WEBPACK_IMPORTED_MODULE_1__["default"]({
    props: postlist_props
  });
  /*postlist_binding*/
  ...
  return {
    c: function c() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_component)(postlist.$$.fragment);
    ...
    m: function m(target, anchor) {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(postlist, div0, null);
      current = true;
    },
    p: function p(ctx, _ref) {
      ...
      var postlist_changes = {};
      postlist.$set(postlist_changes);
    },
    i: function i(local) {
      if (current) return;
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_in)(postlist.$$.fragment, local);
      current = true;
    },
    o: function o(local) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_out)(postlist.$$.fragment, local);
      current = false;
    },
    d: function d(detaching) {
      ...
      ctx[1](null);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.destroy_component)(postlist);
    }
  };
}
...
function instance($$self, $$props, $$invalidate) {
  ...
  function postlist_binding($$value) {
    svelte_internal__WEBPACK_IMPORTED_MODULE_0__.binding_callbacks[$$value ? 'unshift' : 'push'](function () {
      postList = $$value;
      $$invalidate(0, postList);
    });
  }

  return [postList, postlist_binding];
}

var Post = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(Post, _SvelteComponent);
...
/***/ "./resources/js/components/post/PostList.svelte":
/*!******************************************************!*\
  !*** ./resources/js/components/post/PostList.svelte ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* resources/js/components/post/PostList.svelte generated by Svelte v3.49.0 */
...
function instance($$self, $$props, $$invalidate) {
  ...
  var getPosts = function getPosts() {
    var url = "/posts/list/?page=".concat(page);
    axios.get(url).then(function (response) {
      $$invalidate(0, posts = response.data.data);
  ...
  return [posts, hasPrevPage, hasNextPage, onMovePage, getPosts, click_handler, click_handler_1];
}

var PostList = /*#__PURE__*/function (_SvelteComponent) {
  _inherits(PostList, _SvelteComponent);
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_Post_svelte__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/Post.svelte */ "./resources/js/components/Post.svelte");
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");


new _components_Post_svelte__WEBPACK_IMPORTED_MODULE_0__["default"]({
