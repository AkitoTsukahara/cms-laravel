...
abstract class BaseEnum
{
    ...
    public static function enumNameList(): array
    {
    ...
    public function getLowerEnumName(): string
    {
        return strtolower($this->getEnumName());
    }

    public static function lowerEnumNameList(): array
    {
        return array_map(
            fn(string $v) => strtolower($v),
            self::enumNameList()
        );
    }
